...
return [
    ...
    */
    ...
    'permissions' => [
        // NOTE: keep separator as ':' - this Shield build rejects '_' with snake-style
        // case formats (validateSeparatorCaseCompatibility). ':' + 'lower_snake' generates
        // e.g. 'view_any:user' to match the app's lowercase snake case policy keys.
        'separator' => ':',
        'case' => 'lower_snake',
        'generate' => true,
    ],
